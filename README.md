...
เว็บไซต์คำนวณภาษีเงินได้บุคคลธรรมดา สำหรับประเทศไทย ปี 2569
...
## วิธีใช้งาน
เปิดไฟล์ `เว็บคำนวณภาษี.html` ในเบราว์เซอร์
...
หรือหากต้องการหน้าเริ่มต้นโดยตรง ให้ใช้ `index.html` ซึ่งจะเปลี่ยนเส้นทางไปยัง `เว็บคำนวณภาษี.html`
